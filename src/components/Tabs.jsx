  ...
  <div className="tabs px-2">
    <div className="container">
      <div className="row justify-content-center">
        <div className="nav nav-tabs col-lg-10" id="nav-tab" role="tablist">
        ...
        <div className="tab-content col-lg-10 py-2" id="nav-tab">
          <div className="tab-pane fade show active" id="project-details" role="tabpanel" aria-labelledby="project-details-tab">
            ...
            <table className="text-white col-md-7 me-3">
              ...
              <table className="text-white col-md-4">
                <thead>
                  <tr>
          ...
          <div className="tab-pane fade" id="schedule" role="tabpanel" aria-labelledby="schedule-tab">
            <table className="text-white col-md-12">
              <thead>
                <tr>
                  <th>Round</th>
                  <th>Opens</th>
